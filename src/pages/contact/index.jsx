...
const Contact = () => {
  return (
    <>
      ...
      <div
        id="contact"
        className="w-full bg-primary-bg-color text-primary-text-color mt-24"
      >
        <div className="w-8/12 m-auto bg-card-bg-color border border-card-border-color rounded-sm shadow-sm shadow-card-border-color px-2 py-1">
